...
class Ui_orbitalDialog(object):
    def setupUi(self, orbitalDialog):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(os.path.join(base_path, "icon.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.yawLbl.setTextInteractionFlags(
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(os.path.join(base_path, "Previous_Arrow.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(os.path.join(base_path, "Next_Arrow.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(os.path.join(base_path, "full_screen.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, orbitalDialog):
        ...
        orbitalDialog.setWindowTitle(_translate("orbitalDialog", "Mapupdate360"))
